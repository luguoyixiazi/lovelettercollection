...
let love = 0;
function typewrite() {
    let str = "<你是信的开头<诗的内容<童话的结尾<你是理所当然的奇迹<你是月色真美.<你是我万水千山的冒险<要找的标记点<你是分割我人生的线<又将它们相连<";//利用<作为换行符 -作为空格
    let strp = "";
    let i = 0;
...
let a = [
    { name: "A", yin: 8, str: "<br><br><br>我喜欢你，不分日夜，我喜欢你，无关其他，喜欢便是喜欢，多一点不行，少一点也不可以。" },
    ...
    { name: "D", yin: 4, str: "<br><br><br><br>我想再和你谈谈<br><br>我们的相遇<br><br>与相识" },
